...
<body>
    <h1>MongoDB Sensor Readings</h1>
    <a href="https://vercel-raspberry-pi-server.vercel.app/api/displaySQLMongoDB">Download MongoDB Table Data as CSV[Latest ~4.0mb of readings]</a>
...
<head>
    ...
    <script>
        ...
        function displayTable(data) {
            ...
            const tbody = table.querySelector('tbody');
            const newRow = tbody.insertRow();
            newRow.id = 'vercel-data-table-row';

            const fields = ['date', 'time', 'humiditypercent', 'temperaturefahrenheit', 'temperaturecelsius'];
            fields.forEach((field, index) => {
                const newCell = newRow.insertCell();
                newCell.id = `vercel-data-table-cell-${index + 1}`;
                const text = document.createTextNode(data[field] || '');
                newCell.appendChild(text);
            });
        }
...
<body>
    ...
    <thead>
        <tr id="vercel-data-table-header">
            <th id="vercel-data-table-header-date">Date</th>
            <th id="vercel-data-table-header-time">Time</th>
            <th id="vercel-data-table-header-humiditypercent">Humidity (%)</th>
            <th id="vercel-data-table-header-temperaturefahrenheit">Temperature (F)</th>
            <th id="vercel-data-table-header-temperaturecelsius">Temperature (C)</th>
        </tr>
    </thead>
    <tbody>
        <!-- Data will be inserted here -->
...
CO2\[MH-Z19\]: [https://www.amazon.com/EC-Buying-Monitoring-Concentration-Detection/dp/B0CRKH5XVX/ ](https://www.amazon.com/EC-Buying-Monitoring-Concentration-Detection/dp/B0CRKH5XVX/ )

Temperature/Humidity\[DHT22\]: [https://www.amazon.com/SHILLEHTEK-Digital-Temperature-Humidity-Sensor/dp/B0CN5PN225/ ](https://www.amazon.com/SHILLEHTEK-Digital-Temperature-Humidity-Sensor/dp/B0CN5PN225/ )

Temp/Humidity/Pressure/VOC\[BME680\]: [https://www.amazon.com/CJMCU-680-Temperature-Humidity-Ultra-Small-Development/dp/B07K1CGQTJ/ ](https://www.amazon.com/CJMCU-680-Temperature-Humidity-Ultra-Small-Development/dp/B07K1CGQTJ/ )

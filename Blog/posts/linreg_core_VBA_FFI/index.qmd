...
2.  [How VBA Calls a DLL](#Section2)

3.  [The 32-bit Problem: Stdcall Name Decoration](#Section3)

4.  [Designing a Safe API Across the Boundary](#Section4)

5.  [The Internal Type System](#Section5)

6.  [Building for Both Architectures](#Section6)

7.  [The VBA Wrapper Layer](#Section7)

8.  [Lessons Learned](#Section8)

9.  [Is It Worth It?](#Section9)
...
![Figure 1. The user-facing API: three lines of VBA to run OLS and paste the result table.](vba_wrapper_3lines.png)
...
![Figure 2. Result pasted into the worksheet: coefficients, standard errors, t-stats, p-values, and summary rows.](vba_example_ols_output.png)
...
## Section 2. How VBA Calls a DLL {#Section2}
...
![Figure 3. LR_Init flow: VBA loads the correct DLL from the workbook folder before any calls.](vba_lr_init_flow.png)
...
## Section 3. The 32-bit Problem: Stdcall Name Decoration {#Section3}
...
![Figure 4. Stdcall name decoration on x86: the exported symbol includes the leading underscore and @N stack bytes.](vba_stdcall_decoration.png)
...
## Section 4. Designing a Safe API Across the Boundary {#Section4}
...
![Figure 5. Handle lifecycle across the boundary: fit returns a handle, getters read, and `LR_Free` releases the stored result.](vba_handle_lifecycle.png)
...
## Section 5. The Internal Type System {#Section5}
...
## Section 6. Building for Both Architectures {#Section6}
...
## Section 7. The VBA Wrapper Layer {#Section7}
...
![Figure 6. VBA module layout: declarations at the top, followed by public wrappers that return Excel-friendly results.](vba_module_structure.png)
...
## Section 8. Lessons Learned {#Section8}
...
![Figure 7. Export table inspection: `dumpbin /exports` reveals the decorated x86 name `_LR_OLS@16` instead of `LR_OLS`.](vba_dumpbin_exports.png)
...
## Section 9. Is It Worth It? {#Section9}
...
## Section 10. Conclusion {#Section10}
